...
var employee_tracker = function () {
    inquirer.prompt([{
        ...
        if (answers.prompt === 'View All Department') {
            ...
            var queryString = `SELECT  e.id, e.first_name, e.last_name, r.title, r.salary, m.first_name as 'manager_firstname', m.last_name as 'manager_lastname' FROM employee as e `
            queryString += `join role as r on e.role_id = r.id `
            queryString += `join department as d on r.department_id = d.id `
            queryString += `join employee as m on m.id = e.manager_id `
